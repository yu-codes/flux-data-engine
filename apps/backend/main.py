...
啟動：uvicorn apps.backend.main:app --host 0.0.0.0 --port 8000
"""
...
from apps.backend.routers import system
from apps.backend.routers import typhoon

# === 全域狀態管理 ===
from apps.backend.state import app_state
